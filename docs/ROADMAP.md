...
| Publishing behind a token | later | The owner's direction of 2026-09-19. ADR-066: a published subtree can carry one or more named, revocable tokens; no token issued means no auth, exactly today's ADR-032 behaviour. A share link for someone who doesn't need to be identified, only given the link |
